...
from sam_agent.agent import root_agent
from sam_agent.utils.gcs import create_bucket_if_not_exists
from sam_agent.utils.tracing import CloudTraceLoggingSpanExporter
from sam_agent.utils.typing import Feedback
...
def deploy_agent_engine_app(
    ...
    extra_packages: list[str] = ["./sam_agent"],
    ...
    artifacts_bucket_name = f"{project}-demo3-logs-data"
